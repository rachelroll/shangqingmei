                ...
                <div class="row two-columns-list">
                    ...
                    <div class="row is-flex base-margin-bottom">
                        <div class="col-25">
                            ...
                            <a href="charlestrevail/index.html" class="hover-red">
                        ...
                        <div class="col-25">
                            ...
                            <a href="laurakrajecki/index.html" class="hover-red">
                                <div class="text-medium leading-small half-padding-top">
                                    陈炯
                                </div>
                                <div class="text-medium base-margin-bottom color-dark-gray">
                        ...
                        <div class="col-25">
                            ...
                            <a href="andy-payne/index.html" class="hover-red">
                                <div class="text-medium leading-small half-padding-top">
                                    葛勇
                                </div>
                                <div class="text-medium base-margin-bottom color-dark-gray">
                        ...
                        <div class="col-25">
                            ...
                            <a href="gonzalo-brujo/index.html" class="hover-red">
                                <div class="text-medium leading-small half-padding-top">
                                    唐晓刚
                                </div>
                                <div class="text-medium base-margin-bottom color-dark-gray">
                        ...
                        <div class="col-25">
                            ...
                            <a href="rebecca-robins/index.html" class="hover-red">
                                <div class="text-medium leading-small half-padding-top">
                                    鲁晋及
                                </div>
                                <div class="text-medium base-margin-bottom color-dark-gray">
