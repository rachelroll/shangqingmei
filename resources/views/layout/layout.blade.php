...
<head>
    ...
    <link rel="alternate" type="application/json+oembed"
          href="../wp-json/oembed/1.0/embed-url=https---www.interbrand.com-life-at-interbrand-.json"/>
    ...
    <script type='application/ld+json'>
        {"@context":"http:\/\/schema.org","@type":"WebSite","@id":"#website","url":"https:\/\/www.interbrand.com\/","name":"Interbrand","potentialAction":{"@type":"SearchAction","target":"https:\/\/www.interbrand.com\/?s={search_term_string}","query-input":"required name=search_term_string"}}
    </script>
    <!-- / Yoast SEO plugin. -->
    ...
    <script type="text/javascript">
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {"concatemoji": "https:\/\/www.interbrand.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.9.1"}
        };
        !function (a, b, c) {
            function d(a, b) {
...
<!-- Google Tag Manager -->
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K5SGSC" height="0" width="0"
